...
// injectScript('inject.js', function() {
    $(document).ready(function() {
        let imageUrl = '';
        try {
            imageUrl = chrome.runtime.getURL('assets/marker-icon.png');
